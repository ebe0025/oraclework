...
/*
   ...
   [표현법]
   -데이터 타입 수정
    MODIFY 컬럼명 바꾸자하는데이터타입 [DEFAULT 기본값]
    
    - DEFAULT 값 수정
     MODIFY 컬럼명 DEFAULT 바꾸자하는 기본값
*/ 
-- DEPT_COPY 테이블의 DEPT_ID의 자료형을 CHAR(3) 변경
ALTER TABLE DEPT_COPY MODIFY DEPT_ID CHAR(3);


-- DEPT_COPY 테이블의 DEPT_ID의 자료형을 NUMBER 변경
-- 오류 : 숫자로 변경할 수 없는 값이 들어있음
ALTER TABLE DEPT_COPY MODIFY DEPT_ID NUMBER;

-- DEPT_COPY 테이블의 DEPT_TITLE의 자료형을 VARCHAR2(10) 변경
-- 오류 : 들어있는 데이터값이 변경하고자하는 자료형보다 큰 값이 들어 있기 때문
...
*/
-- DEPARTMENT 테이블을 복사하여 DEPT_COPY 테이블만들기
...
ALTER TABLE DEPT_COPY ADD LNAME VARCHAR2(10) DEFAULT '한국' NOT NULL;
ALTER TABLE DEPT_COPY MODIFY LNAME VARCHAR2(30) DEFAULT '미국';
...
*/
-- DEPT_COPY테이블의 DEPT_TITLE 컬럼명을 DEPT_NAME으로 변경
...
/*
     3.2 제약조건명 변경
        ...
        [표현법]
        RENAME CONSTRAINT 기존제약조건명 TO 바꿀조건명명
        
*/
ALTER TABLE DEPT_COPY ADD CONSTRAINT DCOPY_PK PRIMARY KEY(DEPT_ID)
                      ADD CONSTRAINT DCOPY_UQ UNIQUE(DEPT_NAME);
ALTER TABLE DEPT_COPY 
       MODIFY LNAME VARCHAR2(30) DEFAULT '미국' CONSTRAINT DCOPY_NN NOT NULL;
